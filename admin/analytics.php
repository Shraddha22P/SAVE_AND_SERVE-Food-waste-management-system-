...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Save And <b style="color: #06C167; ">Serve</b></p>
             <p class="user"></p>
...
<script>
      <?php
            ...
            $madurai=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"pune\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $chennai=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"solapur\"";
...
var xplace=["Mumbai","Pune","Solapur"];
